...
filepath = 'D:\VIT\Sem 3\DL\Projects\Festival\Plant-Leaf-Disease-Prediction-main2\Plant-Leaf-Disease-Prediction-main\model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join(r'D:\VIT\Sem 3\DL\Projects\Festival\Plant-Leaf-Disease-Prediction-main2\Plant-Leaf-Disease-Prediction-main\static\upload',filename)
        file.save(file_path)
